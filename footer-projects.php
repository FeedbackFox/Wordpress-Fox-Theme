...
<footer>
  ...
  <div class="footer__copyrightsection">
      <?php $page_id = get_queried_object_id();
        if($page_id != 145) {
          echo "        <p class='footer__copyright'>© 2018 Timo Raterink. All Rights Reserved.</p>
          <div class='footer__navbarwrapper'>
          <a href='" . esc_url( home_url() ) . "' class='footer__navbaritem'>Home</a>
          <a href='" . get_page_link( get_page_by_title( "Projects" )->ID ) . "' class='footer__navbaritem'>Projects</a>
          <a href='" . get_page_link( get_page_by_title( "Contact" )->ID) . "' class='footer__navbaritem'>Contact</a>";
        }
        else {
          echo "        <p class='footer__copyright'>© 2018 Timo Raterink. Alle rechten gereserveerd.</p>
          <div class='footer__navbarwrapper'>
          <a href='" . esc_url( home_url() ) . "' class='footer__navbaritem'>Home</a>
          <a href='" . get_page_link( 145 ) . "' class='footer__navbaritem'>Portfolio</a>
